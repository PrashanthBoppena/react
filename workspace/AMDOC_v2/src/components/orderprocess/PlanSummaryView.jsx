...
const PlanSummaryView = ({ selectedPlan, step1Data }) => {
  if (!selectedPlan) {
    return null;
  }
    ...
    <Card>
      <CardContent>
        ...
        <List dense>
          ...
          <ListItem>
            <ListItemText primary={<Typography variant="body1"><strong>Transfer number:</strong>{step1Data.mobileNumber}</Typography>} />
          </ListItem>
        </List>
        ...
        <List dense>
          <ListItem>
            <Grid container alignItems="center">
              ...
              <Grid item xs={3}>
                <ListItemText primary={<Typography variant="body1"> {step1Data.roaming}</Typography>} />
              </Grid>
            </Grid>
          </ListItem>
        </List>
